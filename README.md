...
<!-- BLOGPOSTS:START -->
 ...
 - 💯 [How to Build a Mobile App with Ionic Framework and Rails: A Step-by-Step Guide](https://carlosmv.hashnode.dev/how-to-build-a-mobile-app-with-ionic-framework-and-rails-a-step-by-step-guide)<!-- BLOGPOSTS:END -->
